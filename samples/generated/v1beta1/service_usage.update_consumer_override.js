...
function main() {
  // [START serviceusage_update_consumer_override_sample]
  /**
  ...
  async function updateConsumerOverride() {
    // Construct request
    const request = {};

    // Run request
    const [operation] = await serviceusageClient.updateConsumerOverride(
      request
    );
  ...
  // [END serviceusage_update_consumer_override_sample]
}
